...
namespace DeliverySave
{
    public class AddressController
    {
        ...
        public bool getAllDistrict()
        {
            ...
            if (taskProvinces.Result == null || taskProvinces.Result.Count == 0)
            {
            ...
            foreach (var province in taskProvinces.Result)
            {
        ...
        public bool getAllWard()
        {
            ...
            foreach(var province in taskProvinces.Result) 
            {
                ...
                if (taskDistrict.Result != null && taskDistrict.Result.Count > 0)
                    districts.AddRange(taskDistrict.Result);
            }
